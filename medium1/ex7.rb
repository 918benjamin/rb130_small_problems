...
#       conditional_check = if block_given?
#                             yield(array[index - 1], array[index])
#                           else
#                             array[index - 1] <= array[index]
#                           end
#       next if conditional_check
...
# block should perform some sort of transformation to the argument, and #bubble_sort!
# itself should just use <= to compare two values. In other words, you should be
# able to call #bubble_sort! like this:
